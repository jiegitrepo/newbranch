...
resp = requests.post("https://192.168.25.100/api/aaaLogin.json", data=encoded_body, verify=False)
...
tenants = requests.get("https://192.168.25.100/api/node/class/fvTenant.json?rsp-subtree-include=health,faults", headers=header, verify=False)
